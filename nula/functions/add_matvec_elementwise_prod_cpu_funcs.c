...
#define __PYX_HAVE__nula__functions__add_matvec_elementwise_prod_cpu_funcs
#define __PYX_HAVE_API__nula__functions__add_matvec_elementwise_prod_cpu_funcs
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
static const char *__pyx_f[] = {
  "nula/functions/add_matvec_elementwise_prod_cpu_funcs.pyx",
  "__init__.pxd",
  "stringsource",
  "type.pxd",
};
...
/* Module declarations from 'nula.functions.add_matvec_elementwise_prod_cpu_funcs' */
...
#define __Pyx_MODULE_NAME "nula.functions.add_matvec_elementwise_prod_cpu_funcs"
int __pyx_module_is_main_nula__functions__add_matvec_elementwise_prod_cpu_funcs = 0;

/* Implementation of 'nula.functions.add_matvec_elementwise_prod_cpu_funcs' */
...
static char __pyx_k_nogil[] = "nogil";
...
static char __pyx_k_get_ga[] = "get_ga";
static char __pyx_k_guided[] = "guided";
...
static char __pyx_k_home_bordingj_Copy_Neural_Layer[] = "/home/bordingj/Copy/Neural-Layers/nula/functions/add_matvec_elementwise_prod_cpu_funcs.pyx";
...
static char __pyx_k_nula_functions_add_matvec_elemen[] = "nula.functions.add_matvec_elementwise_prod_cpu_funcs";
...
static PyObject *__pyx_n_s_nula_functions_add_matvec_elemen;
...
static PyObject *__pyx_pf_4nula_9functions_37add_matvec_elementwise_prod_cpu_funcs_get_ga(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_gy, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_ga); /* proto */
...
/* "nula/functions/add_matvec_elementwise_prod_cpu_funcs.pyx":10
...
/* Python wrapper */
static PyObject *__pyx_pw_4nula_9functions_37add_matvec_elementwise_prod_cpu_funcs_1get_ga(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4nula_9functions_37add_matvec_elementwise_prod_cpu_funcs_1get_ga = {"get_ga", (PyCFunction)__pyx_pw_4nula_9functions_37add_matvec_elementwise_prod_cpu_funcs_1get_ga, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4nula_9functions_37add_matvec_elementwise_prod_cpu_funcs_1get_ga(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_gy,&__pyx_n_s_x,&__pyx_n_s_ga,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_gy)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_x)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_ga", 1, 3, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ga)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_ga", 1, 3, 3, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_ga") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_gy = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_float32_t(values[0]); if (unlikely(!__pyx_v_gy.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_float32_t(values[1]); if (unlikely(!__pyx_v_x.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_ga = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float32_t(values[2]); if (unlikely(!__pyx_v_ga.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_ga", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("nula.functions.add_matvec_elementwise_prod_cpu_funcs.get_ga", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4nula_9functions_37add_matvec_elementwise_prod_cpu_funcs_get_ga(__pyx_self, __pyx_v_gy, __pyx_v_x, __pyx_v_ga);
...
static PyObject *__pyx_pf_4nula_9functions_37add_matvec_elementwise_prod_cpu_funcs_get_ga(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_gy, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_ga) {
  int __pyx_v_N;
  int __pyx_v_M;
  ...
  /* "nula/functions/add_matvec_elementwise_prod_cpu_funcs.pyx":12
 * def get_ga(np.float32_t[:,:] gy, np.float32_t[:,:] x, np.float32_t[:] ga):
 *     cdef:
 *         int N = gy.shape[0]             # <<<<<<<<<<<<<<
 *         int M = gy.shape[1]
 *         np.intp_t i, j
 */
  __pyx_v_N = (__pyx_v_gy.shape[0]);

  /* "nula/functions/add_matvec_elementwise_prod_cpu_funcs.pyx":13
 *     cdef:
 *         int N = gy.shape[0]
 *         int M = gy.shape[1]             # <<<<<<<<<<<<<<
 *         np.intp_t i, j
 ...
 */
  __pyx_v_M = (__pyx_v_gy.shape[1]);

  /* "nula/functions/add_matvec_elementwise_prod_cpu_funcs.pyx":15
 *         int M = gy.shape[1]
 *         np.intp_t i, j
 *     for i in range(N, schedule='guided', nogil=True):             # <<<<<<<<<<<<<<
 *         ga[i] = 0
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_schedule, __pyx_n_s_guided) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_nogil, Py_True) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (likely(PyList_CheckExact(__pyx_t_3)) || PyTuple_CheckExact(__pyx_t_3)) {
    ...
    __pyx_t_4 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_t_3); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_5 = Py_TYPE(__pyx_t_1)->tp_iternext; if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  for (;;) {
    if (likely(!__pyx_t_5)) {
      if (likely(PyList_CheckExact(__pyx_t_1))) {
        ...
        #if CYTHON_COMPILING_IN_CPYTHON
        __pyx_t_3 = PyList_GET_ITEM(__pyx_t_1, __pyx_t_4); __Pyx_INCREF(__pyx_t_3); __pyx_t_4++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        #else
        __pyx_t_3 = PySequence_ITEM(__pyx_t_1, __pyx_t_4); __pyx_t_4++; if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        #endif
      } else {
        if (__pyx_t_4 >= PyTuple_GET_SIZE(__pyx_t_1)) break;
        #if CYTHON_COMPILING_IN_CPYTHON
        __pyx_t_3 = PyTuple_GET_ITEM(__pyx_t_1, __pyx_t_4); __Pyx_INCREF(__pyx_t_3); __pyx_t_4++; if (unlikely(0 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        #else
        __pyx_t_3 = PySequence_ITEM(__pyx_t_1, __pyx_t_4); __pyx_t_4++; if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        #endif
    ...
    __pyx_t_6 = __Pyx_PyInt_As_Py_intptr_t(__pyx_t_3); if (unlikely((__pyx_t_6 == (npy_intp)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_v_i = __pyx_t_6;

    /* "nula/functions/add_matvec_elementwise_prod_cpu_funcs.pyx":16
 *         np.intp_t i, j
 *     for i in range(N, schedule='guided', nogil=True):
 *         ga[i] = 0             # <<<<<<<<<<<<<<
 *         for j in range(M):
 ...
 */
    __pyx_t_7 = __pyx_v_i;
    *((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_ga.data + __pyx_t_7 * __pyx_v_ga.strides[0]) )) = 0.0;

    /* "nula/functions/add_matvec_elementwise_prod_cpu_funcs.pyx":17
 *     for i in range(N, schedule='guided', nogil=True):
 *         ga[i] = 0
 *         for j in range(M):             # <<<<<<<<<<<<<<
 *             ga[i] += gy[i,j]*x[i,j]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_8; __pyx_t_6+=1) {
      ...
      /* "nula/functions/add_matvec_elementwise_prod_cpu_funcs.pyx":18
 *         ga[i] = 0
 *         for j in range(M):
 *             ga[i] += gy[i,j]*x[i,j]             # <<<<<<<<<<<<<<
 *     return np.array(ga, np.float32, copy=False, order='C')
 */
      ...
      *((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_ga.data + __pyx_t_13 * __pyx_v_ga.strides[0]) )) += ((*((__pyx_t_5numpy_float32_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_gy.data + __pyx_t_9 * __pyx_v_gy.strides[0]) ) + __pyx_t_10 * __pyx_v_gy.strides[1]) ))) * (*((__pyx_t_5numpy_float32_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_x.data + __pyx_t_11 * __pyx_v_x.strides[0]) ) + __pyx_t_12 * __pyx_v_x.strides[1]) ))));
    }
 ...
 */
  ...
  /* "nula/functions/add_matvec_elementwise_prod_cpu_funcs.pyx":19
 *         for j in range(M):
 *             ga[i] += gy[i,j]*x[i,j]
 *     return np.array(ga, np.float32, copy=False, order='C')             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_ga, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_float32_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_float32_t, 0);; if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_float32); if (unlikely(!__pyx_t_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_1 = 0;
  __pyx_t_14 = 0;
  __pyx_t_14 = PyDict_New(); if (unlikely(!__pyx_t_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_14);
  if (PyDict_SetItem(__pyx_t_14, __pyx_n_s_copy, Py_False) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyDict_SetItem(__pyx_t_14, __pyx_n_s_order, __pyx_n_s_C) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_2, __pyx_t_14); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "nula.functions.add_matvec_elementwise_prod_cpu_funcs.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "nula.functions.add_matvec_elementwise_prod_cpu_funcs.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "nula.functions.add_matvec_elementwise_prod_cpu_funcs.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "nula.functions.add_matvec_elementwise_prod_cpu_funcs._memoryviewslice", /*tp_name*/
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "add_matvec_elementwise_prod_cpu_funcs",
    0, /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_nula_functions_add_matvec_elemen, __pyx_k_nula_functions_add_matvec_elemen, sizeof(__pyx_k_nula_functions_add_matvec_elemen), 0, 0, 1, 1},
 ...
 *         int N = gy.shape[0]
 */
  __pyx_tuple__20 = PyTuple_Pack(7, __pyx_n_s_gy, __pyx_n_s_x, __pyx_n_s_ga, __pyx_n_s_N, __pyx_n_s_M, __pyx_n_s_i, __pyx_n_s_j); if (unlikely(!__pyx_tuple__20)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(3, 0, 7, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_bordingj_Copy_Neural_Layer, __pyx_n_s_get_ga, 10, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initadd_matvec_elementwise_prod_cpu_funcs(void); /*proto*/
PyMODINIT_FUNC initadd_matvec_elementwise_prod_cpu_funcs(void)
#else
PyMODINIT_FUNC PyInit_add_matvec_elementwise_prod_cpu_funcs(void); /*proto*/
PyMODINIT_FUNC PyInit_add_matvec_elementwise_prod_cpu_funcs(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_add_matvec_elementwise_prod_cpu_funcs(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("add_matvec_elementwise_prod_cpu_funcs", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_nula__functions__add_matvec_elementwise_prod_cpu_funcs) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "nula.functions.add_matvec_elementwise_prod_cpu_funcs")) {
      if (unlikely(PyDict_SetItemString(modules, "nula.functions.add_matvec_elementwise_prod_cpu_funcs", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "nula/functions/add_matvec_elementwise_prod_cpu_funcs.pyx":2
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport cython
 ...
 *         int N = gy.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4nula_9functions_37add_matvec_elementwise_prod_cpu_funcs_1get_ga, NULL, __pyx_n_s_nula_functions_add_matvec_elemen); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_get_ga, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init nula.functions.add_matvec_elementwise_prod_cpu_funcs", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init nula.functions.add_matvec_elementwise_prod_cpu_funcs");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
