...
class BLSTMSequenceEmbedwAttention(FunctionSet):
    def __init__(self, in_size, no_labels, no_units):
        ...
        """
        super(BLSTMSequenceEmbedwAttention, self).__init__(
            # character embedding
    ...
    def get_context(self, h2_forward_list, h2_backward_deque):
    ...
    def forward(self, X, dropout_ratio, train=True, on_gpu=False):
        ...
        for t in reversed(range(T)):
            states_tp1 = self.get_backward_states(h0_list[t], states_tp1, 
                                                  ...
                                                  train=train)
            if t%10==0:
                h_backward_deque.appendleft(states_tp1['h2'])
